...
<div class="container py-4">
    ...
    <form action="{{ route('cases.update', $case) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="case_title" class="form-control" value="{{ old('case_title', $case->case_title) }}" required>
            @error('case_title')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" name="judge_name" class="form-control" value="{{ old('judge_name', $case->judge_name) }}">
            @error('judge_name')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
