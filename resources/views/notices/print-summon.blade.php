...
<body  onload="window.print();">
    ...
    <div class="line">بعد از جناب <span class="underline">{{ $data['judge_name'] }} سنئیر سول جج، سول جج، جج فیملی، جج گارڈین کنٹرول</span></div>
    ...
    <div class="line">درخواست دعویٰ عدالت ہٰذا میں برائے <span class="underline"></span> گزاری ہے۔</div>

    <div class="line">
        داور! آپ کا براہ راست جواب دہی درخو است و دعویٰ حاضری عدالت ہونا ضروری ہے۔ لہٰذا آپ کو بذریعہ نوٹس ہٰذا  مطلع کیا جاتا ہے
        کہ آپ بتاریخ {{ $data['hearing_date'] }} بوقت {{ $data['hearing_time'] ?? '08:00' }} بجے دن، عدالت میں اصالتاً یا وکالتاً حاضر ہو کر
        حق دفاع کی درخواست گزاریں۔ اگر کوئی عذر ہو تو پیش کریں۔ بصورتِ عدم حاضری، کارروائی کی جائے گی۔
        (نقل در درخواست دعویٰ لف ہے)۔
    </div>

    <div class="line">
        آج بتاریخ {{ $data['hearing_date'] }} ماہ {{ $data['month_year'] }}، یہ نوٹس ہمارے دستخط اور مہر عدالت سے جاری کیا گیا ہے۔
    </div>
